...
<form id="eform" action="updateall.php" method="post">
	...
	<p><label for="jobname">Enter Job Title:</label>
		<input type="text" name="jobtitle" id="jobname" size="20" required="required" />
	</p>

	<p><label for="jobreference">Enter Job Reference Number:</label>
		<input type="text" name="jobreference" id="jobreference" size="20" required="required" />
	</p>
